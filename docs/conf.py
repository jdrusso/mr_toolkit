...
project = 'Markov Reweighting Toolkit'
copyright = ("2023, John Russo. Project structure based on the "
...
htmlhelp_basename = 'mr_toolkitdoc'
...
latex_documents = [
    (master_doc, 'mr_toolkit.tex', 'Markov Reweighting Toolkit Documentation',
     'mr_toolkit', 'manual'),
]
...
man_pages = [
    (master_doc, 'mr_toolkit', 'Markov Reweighting Toolkit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mr_toolkit', 'Markov Reweighting Toolkit Documentation',
     author, 'mr_toolkit', 'A short description of the project (less than one line).',
     'Miscellaneous'),
]
